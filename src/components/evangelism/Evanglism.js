                ...
                <div className="container-fluid">
                    <div className="row  ptb">
                        <div className="col-sm-8 col-10 mx-auto text-cnter">
                            ...
                            <p className='mt-3'>Every Whitelisted Address collects a Credit which is equal to the Downline Address’ Level’s coefficient times the Downline Address’ Total Earnings in MoroccoSwap from Free Roulette and Farms and Banks (calculated in ANTI in real-time based on the price feed of MoroccoSwap)</p>
                            <p className='mt-3'>Credit = Level Coefficient x referral earnings calculated in ANTI</p>
                            <p className='mt-3'>The Level Coefficient of the MoroccoSwap earnings of each Level of the Evangelist’s downline:</p>
                            ...
                            <p className='mt-3'>Credit Ratio = Evangelist Credit / Total Credit By All MoroccoSwap Evangelists</p>
                            <p className='mt-3'>The trade fee and LP tax that comes from MoroccoSwap to Evangelists is automatically distributed proportionally to all Evangelists based on their Credit Ratio. For example an Evangelist with a Credit Ratio of 15% will receive 15% of what came to Evangelists from MoroccoSwap</p>
